...
function SingUP(props) {
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(Input, { type: 'text', name: 'name', value: props.userName }),
            React.createElement(
                'p',
                null,
                '\u30E1\u30FC\u30EB\u30A2\u30C9\u30EC\u30B9'
            ),
            React.createElement(Input, { type: 'text', name: 'email', value: props.userEmail }),
            React.createElement(
                'p',
                null,
                '\u30D1\u30B9\u30EF\u30FC\u30C9'
            ),
            React.createElement(Input, { type: 'text', name: 'password', value: props.userPassword }),
...
function Header() {
    return React.createElement(
        'header',
        null,
        React.createElement(SearchForm, { route: 'posts/test', 'class': 'search topSearch searchForm searchForm1' }),
